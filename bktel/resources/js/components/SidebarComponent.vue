               ...
               with font-awesome or any other icon font library -->
                    <li class="nav-item menu-open">
                        <a href="#" class="nav-link active">
                            <i
                                class="nav-icon fa fa-tachometer"
                                aria-hidden="true"
                            ></i>
                            <p>
                                Dashboard
                                <i
                                    class="right fa fa-chevron-circle-left right"
                                    aria-hidden="true"
                                ></i>
                            </p>
                        </a>
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            <i
                                class="nav-icon fa fa-laptop"
                                aria-hidden="true"
                            ></i>
                            <p>
                                Layout Options
                                <i
                                    class="fa fa-chevron-circle-left right right"
                                    aria-hidden="true"
                                ></i>
                    ...
                    <li class="nav-item">
                        <a href="pages/gallery.html" class="nav-link">
                            <i
                                class="nav-icon fa fa-picture-o"
                                aria-hidden="true"
                            ></i>
                            <p>Gallery</p>
                        </a>
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            <i
                                class="fa nav-icon fa-book"
                                aria-hidden="true"
                            ></i>
                            <p>
                                Pages
                                <i
                                    class="fa fa-chevron-circle-left right"
                                    aria-hidden="true"
                                ></i>
                            </p>
                        </a>
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            <i
                                class="fa nav-icon fa-plus-square"
                                aria-hidden="true"
                            ></i>
                            <p>
                                Extras
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            <i
                                class="fa fa-circle-o text-danger"
                                aria-hidden="true"
                            ></i>
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            <i
                                class="fa fa-circle-o text-warning"
                                aria-hidden="true"
                            ></i>
                            <p>Warning</p>
                        </a>
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            <i
                                class="fa fa-circle-o text-info"
                                aria-hidden="true"
                            ></i>
                            <p>Informational</p>
                        </a>
