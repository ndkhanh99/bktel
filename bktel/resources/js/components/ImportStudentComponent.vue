<template>
    ...
    <div class="import-teacher-new" >
        ...
        <div style="font-size:20px; background-color:none;height:30px; width: fit-content; text-align:center; align-content: center;align-items: center; border:0px none  ; margin-left: 35px;">
            <p style="color:rgb(229, 231, 114);text-align:center;">{{ error_import_student }}</p>
        </div>
        ...
        <div class="import-div-submit">
                ...
                <button class="import-btn-create-teacher-new-1 " type="submit" @click="saveForm_import_student">Upload</button>
        ...
        methods: {
            ...
            saveForm_import_student: function() {
               ...
               .catch((error) => {
                    ...
                    this.error_import_student = 'Thông tin không hợp lệ, vui lòng thử lại';
                });
        },
             cancel(){
